...
const Blog_template = () => {
    ...
    return ( 
        <div className="flex justify-center content-center">
            <div className="w-[1080px] h-[100%] bg-[#313131] mt-20 mb-14 pb-20 rounded-3xl shadow-2xl">
                ...
                <div className=" w-[750px] h-[100px]  ml-64 mt-2 pl-2 font-semibold font-mono">
                    <h6 className="text-[50px] tracking-tight underline">Title of the Blog.</h6>
                    <h5>{time + ' / ' + date + ' by: ' + author}</h5>
                </div>
