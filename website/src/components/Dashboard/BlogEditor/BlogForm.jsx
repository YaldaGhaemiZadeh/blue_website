const BlogForm = () => {
    return ( 
        <form action="" className="w-[750px] h-[500px] flex flex-col gap-3 px-6 py-5 bg-[#313131] shadow-xl rounded-3xl">
          ...
          <button className="w-[120px] h-[50px] bg-red-900 rounded-lg">Delete</button>
          <button className="w-[120px] h-[50px] bg-[#3b3b3b] rounded-lg">???</button>
          <button className="w-[120px] h-[50px] bg-[#3b3b3b] rounded-lg">???</button>
               </div>
            <textarea className="h-[300px] rounded-xl p-5 text-2xl"></textarea>
        </form>
     );
}
